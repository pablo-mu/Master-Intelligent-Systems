...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out, cache2 = fc_relu_forward(out, W2, b2)
        scores, cache3 = fc_forward(out, W3, b3)
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        # Compute the gradients for the three layers using a backward pass
        dout, dW3, db3 = fc_backward(dscores, cache3)
        dout, dW2, db2 = fc_relu_backward(dout, cache2)
