// Calculus of pi using the rectangle method and 
// parallelizing the calculus of the area of each rectangle using OpenMP
// Each thread accumulates all its computations on shared variable pi
#include <stdio.h>
#include <stdlib.h>
#include <omp.h>
